            ...
            <v-sheet :rounded="!isTile" :tile="isTile" :flat="isTile" :width="cardWidth" color="#ADD8E6">
                    ...
                    <v-card-subtitle>
                        ...
                        >
                            <template slot="prepend-inner">
                                <v-icon size="x-small" :color="name.length === 0 ? 'red' : 'blue'">fiber_manual_record
                                </v-icon>
                            </template>
                        </v-text-field>
                        <v-textarea
                        ...
                        <v-checkbox v-model="loginRequired" hide-details>
                ...
                >
                    ...
                    <v-card-text v-if="question.type!=='Текстовый ответ'">
                        <v-card outlined style="background-color: #9E9E9E">
                            <v-card-actions
